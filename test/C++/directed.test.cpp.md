...
data:
  ...
  bundledCode: "#line 1 \"test/C++/directed.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/GRL_2_B\"\
    ...
    #line 4 \"test/C++/directed.test.cpp\"\nint main() {\n    int v, e, r;\n    std::cin\
  ...
  verifiedWith: []
documentation_of: test/C++/directed.test.cpp
layout: document
redirect_from:
- /verify/test/C++/directed.test.cpp
- /verify/test/C++/directed.test.cpp.html
