...
data:
  ...
  bundledCode: "#line 1 \"test/C++/uf.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/unionfind\"\
  ...
  verifiedWith: []
documentation_of: test/C++/uf.test.cpp
layout: document
redirect_from:
- /verify/test/C++/uf.test.cpp
- /verify/test/C++/uf.test.cpp.html
