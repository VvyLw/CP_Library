...
data:
  ...
  bundledCode: "#line 1 \"test/C++/lazysegtree.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/DSL_2_D\"\
    ...
    \ */\n#line 4 \"test/C++/lazysegtree.test.cpp\"\nint main() {\n    std::cin.tie(nullptr)\
  ...
  verifiedWith: []
documentation_of: test/C++/lazysegtree.test.cpp
layout: document
redirect_from:
- /verify/test/C++/lazysegtree.test.cpp
- /verify/test/C++/lazysegtree.test.cpp.html
