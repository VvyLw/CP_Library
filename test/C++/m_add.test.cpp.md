...
data:
  ...
  bundledCode: "#line 1 \"test/C++/m_add.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/many_aplusb\"\
  ...
  verifiedWith: []
documentation_of: test/C++/m_add.test.cpp
layout: document
redirect_from:
- /verify/test/C++/m_add.test.cpp
- /verify/test/C++/m_add.test.cpp.html
