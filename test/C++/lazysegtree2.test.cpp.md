...
data:
  ...
  bundledCode: "#line 1 \"test/C++/lazysegtree2.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/DSL_2_F\"\
    ...
    \ */\n#line 4 \"test/C++/lazysegtree2.test.cpp\"\nint main() {\n    std::cin.tie(nullptr)\
  ...
  verifiedWith: []
documentation_of: test/C++/lazysegtree2.test.cpp
layout: document
redirect_from:
- /verify/test/C++/lazysegtree2.test.cpp
- /verify/test/C++/lazysegtree2.test.cpp.html
