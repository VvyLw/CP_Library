...
data:
  ...
  bundledCode: "#line 1 \"test/C++/knapsack5.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/DPL_1_C\"\
    ...
    \ */\n\n/**\n * @brief DP(Knapsack, LCS, LIS)\n */\n#line 4 \"test/C++/knapsack5.test.cpp\"\
    \nint main() {\n    int n, wg;\n    std::cin >> n >> wg;\n    std::vector<int>\
    \ v(n), w(n);\n    for(int i = 0; i < n; ++i) {\n        std::cin >> v[i] >> w[i];\n\
  ...
  verifiedWith: []
documentation_of: test/C++/knapsack5.test.cpp
layout: document
redirect_from:
- /verify/test/C++/knapsack5.test.cpp
- /verify/test/C++/knapsack5.test.cpp.html
