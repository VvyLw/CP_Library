...
data:
  ...
  bundledCode: "#line 1 \"test/C++/aarray.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/associative_array\"\
  ...
  verifiedWith: []
documentation_of: test/C++/aarray.test.cpp
layout: document
redirect_from:
- /verify/test/C++/aarray.test.cpp
- /verify/test/C++/aarray.test.cpp.html
