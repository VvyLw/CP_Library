...
data:
  ...
  bundledCode: "#line 1 \"test/C++/lcpa.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/number_of_substrings\"\
  ...
  verifiedWith: []
documentation_of: test/C++/lcpa.test.cpp
layout: document
redirect_from:
- /verify/test/C++/lcpa.test.cpp
- /verify/test/C++/lcpa.test.cpp.html
