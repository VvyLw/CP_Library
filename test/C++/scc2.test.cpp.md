...
data:
  ...
  bundledCode: "#line 1 \"test/C++/scc2.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/scc\"\
  ...
  verifiedWith: []
documentation_of: test/C++/scc2.test.cpp
layout: document
redirect_from:
- /verify/test/C++/scc2.test.cpp
- /verify/test/C++/scc2.test.cpp.html
