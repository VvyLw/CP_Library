...
data:
  ...
  bundledCode: "#line 1 \"test/C++/s_rmq.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/staticrmq\"\
  ...
  verifiedWith: []
documentation_of: test/C++/s_rmq.test.cpp
layout: document
redirect_from:
- /verify/test/C++/s_rmq.test.cpp
- /verify/test/C++/s_rmq.test.cpp.html
