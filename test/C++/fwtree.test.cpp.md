...
data:
  ...
  bundledCode: "#line 1 \"test/C++/fwtree.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/point_add_range_sum\"\
  ...
  verifiedWith: []
documentation_of: test/C++/fwtree.test.cpp
layout: document
redirect_from:
- /verify/test/C++/fwtree.test.cpp
- /verify/test/C++/fwtree.test.cpp.html
