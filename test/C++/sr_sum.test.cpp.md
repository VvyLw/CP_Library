...
data:
  ...
  bundledCode: "#line 1 \"test/C++/sr_sum.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/static_range_sum\"\
  ...
  verifiedWith: []
documentation_of: test/C++/sr_sum.test.cpp
layout: document
redirect_from:
- /verify/test/C++/sr_sum.test.cpp
- /verify/test/C++/sr_sum.test.cpp.html
