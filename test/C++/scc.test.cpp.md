...
data:
  ...
  bundledCode: "#line 1 \"test/C++/scc.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/GRL_3_C\"\
  ...
  verifiedWith: []
documentation_of: test/C++/scc.test.cpp
layout: document
redirect_from:
- /verify/test/C++/scc.test.cpp
- /verify/test/C++/scc.test.cpp.html
