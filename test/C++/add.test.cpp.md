...
data:
  ...
  bundledCode: "#line 1 \"test/C++/add.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/aplusb\"\
  ...
  verifiedWith: []
documentation_of: test/C++/add.test.cpp
layout: document
redirect_from:
- /verify/test/C++/add.test.cpp
- /verify/test/C++/add.test.cpp.html
