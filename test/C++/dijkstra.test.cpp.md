...
data:
  ...
  bundledCode: "#line 1 \"test/C++/dijkstra.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/GRL_1_A\"\
    ...
    \ cst[i][k] + cst[k][j]);\n                }\n            }\n        }\n\t\treturn\
    \ cst;\n\t}\n};\n\n/**\n * @brief \u91CD\u307F\u4ED8\u304D\u30B0\u30E9\u30D5\u30E9\
    \u30A4\u30D6\u30E9\u30EA\n */\n#line 4 \"test/C++/dijkstra.test.cpp\"\nconstexpr\
    \ long long LINF = (1LL << 61) - 1;\nint main() {\n    int v, e, r;\n    std::cin\
    \ >> v >> e >> r;\n    w_graph<false> g(v, 0);\n    g.input(e);\n    const auto\
  ...
  verifiedWith: []
documentation_of: test/C++/dijkstra.test.cpp
layout: document
redirect_from:
- /verify/test/C++/dijkstra.test.cpp
- /verify/test/C++/dijkstra.test.cpp.html
