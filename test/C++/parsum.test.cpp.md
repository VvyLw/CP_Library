...
data:
  ...
  bundledCode: "#line 1 \"test/C++/parsum.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/point_add_range_sum\"\
  ...
  verifiedWith: []
documentation_of: test/C++/parsum.test.cpp
layout: document
redirect_from:
- /verify/test/C++/parsum.test.cpp
- /verify/test/C++/parsum.test.cpp.html
