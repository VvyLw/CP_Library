...
data:
  ...
  verifiedWith: []
documentation_of: test/C++/lis2.test.cpp
layout: document
redirect_from:
- /verify/test/C++/lis2.test.cpp
- /verify/test/C++/lis2.test.cpp.html
