...
data:
  ...
  bundledCode: "#line 1 \"test/C++/stable.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/staticrmq\"\
  ...
  verifiedWith: []
documentation_of: test/C++/stable.test.cpp
layout: document
redirect_from:
- /verify/test/C++/stable.test.cpp
- /verify/test/C++/stable.test.cpp.html
