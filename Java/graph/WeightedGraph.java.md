...
data:
  ...
  bundledCode: "Traceback (most recent call last):\n  File \"/home/runner/.local/lib/python3.10/site-packages/onlinejudge_verify/documentation/build.py\"\
    ...
    RuntimeError: bundler is not specified: Java/graph/WeightedGraph.java\n"
  code: "package library.graph;\n\nimport java.util.ArrayList;\nimport java.util.Arrays;\n\
    ...
    \ Queue<IntPair> dj = new PriorityQueue<>();\n\t\tcost[v] = 0;\n\t\tdj.add(new\
    \ IntPair(cost[v], v));\n\t\twhile(!dj.isEmpty()) {\n\t\t\tfinal IntPair tmp =\
...
layout: document
redirect_from:
- /library/Java/graph/WeightedGraph.java
- /library/Java/graph/WeightedGraph.java.html
