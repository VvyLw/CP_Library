...
data:
  ...
  bundledCode: "Traceback (most recent call last):\n  File \"/home/runner/.local/lib/python3.10/site-packages/onlinejudge_verify/documentation/build.py\"\
    ...
    RuntimeError: bundler is not specified: Java/other/SkewHeap.java\n"
  code: "package library.other;\n\nimport library.graph.WeightedGraph;\n\n/**\n *\
    \ \u306A\u3093\u3067\u3059\u304B\u3053\u308C\u306F\n * \u6700\u5C0F\u6709\u5411\
    \u5168\u57DF\u6728\u3092\u6C42\u3081\u308B\u969B\u306B\u4F7F\u3046\u30AF\u30E9\
    \u30B9\n * \u4E2D\u8EAB\u306F\u3088\u304F\u308F\u304B\u3063\u3066\u3044\u306A\u3044\
    \n * @see WeightedGraph#directed\n * @see <a href=\"https://ei1333.github.io/library/structure/heap/skew-heap.hpp\"\
    ...
    \ < y.key) ^ isMin) {\n\t\t\tfinal Node tmp = x;\n\t\t\tx = y;\n\t\t\ty = tmp;\n\
    \t\t}\n\t\tx.r = meld(y, x.r);\n\t\tfinal Node tmp = x.l;\n\t\tx.l = x.r;\n\t\t\
    x.r = tmp;\n\t\treturn x;\n\t}\n\tpublic final Node push(final Node t, final long\
    \ key, int idx){ return meld(t, alloc(key, idx)); }\n\tpublic final Node pop(final\
    \ Node t) {\n\t\tif(t == null) {\n\t\t\tthrow new NullPointerException();\n\t\t\
    }\n\t\treturn meld(t.l, t.r);\n\t}\n\tpublic final Node add(Node t, final long\
    \ lazy) {\n\t\tif(t != null) {\n\t\t\tt.lazy += lazy;\n\t\t\tpropagate(t);\n\t\
    \t}\n\t\treturn t;\n\t}\n}"
  dependsOn:
  ...
  verifiedWith: []
documentation_of: Java/other/SkewHeap.java
layout: document
redirect_from:
- /library/Java/other/SkewHeap.java
- /library/Java/other/SkewHeap.java.html
