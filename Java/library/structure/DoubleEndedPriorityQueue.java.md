...
data:
  ...
  bundledCode: "Traceback (most recent call last):\n  File \"/home/runner/.local/lib/python3.10/site-packages/onlinejudge_verify/documentation/build.py\"\
    ...
    RuntimeError: bundler is not specified: Java/library/structure/DoubleEndedPriorityQueue.java\n"
  code: "package library.structure;\n\nimport java.util.ArrayList;\nimport java.util.Collections;\n\
    \n/**\n * DoubleEndedPriorityQueue\n * \u4E21\u7AEF\u304B\u3089\u30A2\u30AF\u30BB\
    \u30B9\u3067\u304D\u308BHeapQueue\n * @param <T>\n */\npublic final class DoubleEndedPriorityQueue<T\
    \ extends Number> {\n\tprivate final ArrayList<T> d;\n\t/**\n\t * \u30B3\u30F3\
    \u30B9\u30C8\u30E9\u30AF\u30BF\n\t * @param d\n\t */\n\tpublic DoubleEndedPriorityQueue(final\
    \ ArrayList<T> d) {\n\t\tthis.d = d;\n\t\tmakeHeap();\n\t}\n\tprivate final void\
  ...
  verifiedWith: []
documentation_of: Java/library/structure/DoubleEndedPriorityQueue.java
layout: document
redirect_from:
- /library/Java/library/structure/DoubleEndedPriorityQueue.java
- /library/Java/library/structure/DoubleEndedPriorityQueue.java.html
