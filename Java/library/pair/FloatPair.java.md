...
data:
  ...
  bundledCode: "Traceback (most recent call last):\n  File \"/home/runner/.local/lib/python3.10/site-packages/onlinejudge_verify/documentation/build.py\"\
    ...
    RuntimeError: bundler is not specified: Java/library/pair/FloatPair.java\n"
  code: "package library.pair;\nimport library.core.Utility;\n\npublic final class\
    \ FloatPair extends Pair<Double, Double> {\n\tFloatPair(final double first, final\
    \ double second){ super(first, second); }\n\tfinal FloatPair add(final FloatPair\
  ...
  verifiedWith: []
documentation_of: Java/library/pair/FloatPair.java
layout: document
redirect_from:
- /library/Java/library/pair/FloatPair.java
- /library/Java/library/pair/FloatPair.java.html
