...
data:
  ...
  bundledCode: "Traceback (most recent call last):\n  File \"/home/runner/.local/lib/python3.10/site-packages/onlinejudge_verify/documentation/build.py\"\
    ...
    RuntimeError: bundler is not specified: Java/library/pair/Pair.java\n"
  code: "package library.pair;\n\npublic class Pair<F extends Comparable<? super F>,\
    \ S extends Comparable<? super S>> implements Comparable<Pair<F, S>> {\n\tpublic\
  ...
  verifiedWith: []
documentation_of: Java/library/pair/Pair.java
layout: document
redirect_from:
- /library/Java/library/pair/Pair.java
- /library/Java/library/pair/Pair.java.html
