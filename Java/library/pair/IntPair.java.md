...
data:
  ...
  bundledCode: "Traceback (most recent call last):\n  File \"/home/runner/.local/lib/python3.10/site-packages/onlinejudge_verify/documentation/build.py\"\
    ...
    RuntimeError: bundler is not specified: Java/library/pair/IntPair.java\n"
  code: "package library.pair;\n\nimport library.core.Utility;\n\npublic final class\
    \ IntPair extends Pair<Long, Long> {\n\tpublic IntPair(final long first, final\
    \ long second){ super(first, second); }\n\tfinal IntPair add(final IntPair p){\
...
layout: document
redirect_from:
- /library/Java/library/pair/IntPair.java
- /library/Java/library/pair/IntPair.java.html
