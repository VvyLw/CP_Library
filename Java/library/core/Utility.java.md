...
data:
  ...
  code: "package library.core;\n\nimport java.util.ArrayList;\nimport java.util.Arrays;\n\
    ...
    \ sqr(final long x){ return x * x; }\n\tpublic static final int mod(final int\
    \ n, final int m){ return (n + m) % m; }\n\tpublic static final int mod(final\
    \ long n, final int m){ return (int) (n + m) % m; }\n\tpublic static final long\
    \ mod(final long n, final long m){ return (n + m) % m; }\n\tprotected static final\
    ...
    \ % 2 == 1) {\n\t\t\t\tres *= a;\n\t\t\t\tres = mod(res, m);\n\t\t\t}\n\t\t\t\
    a *= a;\n\t\t\ta = mod(a, m);\n\t\t\tb >>= 1;\n\t\t}\n\t\treturn res;\n\t}\n\t\
    public static final long lcm(final long a, final long b){ return a * b / gcd(a,\
    ...
    \ (x, y) -> Math.min(x, y)); }\n\tpublic static final long min(final long... a){\
    \ return Arrays.stream(a).reduce(Long.MAX_VALUE, (x, y) -> Math.min(x, y)); }\n\
    \tpublic static final int max(final int... a){ return Arrays.stream(a).reduce(Integer.MIN_VALUE,\
    \ (x, y) -> Math.max(x, y)); }\n\tpublic static final long max(final long... a){\
    \ return Arrays.stream(a).reduce(Long.MIN_VALUE, (x, y) -> Math.max(x, y)); }\n\
    ...
    \ <= x && x <= r; }\n\tpublic static final boolean scope(final long l, final long\
    \ x, final long r){ return l <= x && x <= r; }\n\tpublic static final boolean\
    \ scope(final double l, final double x, final double r){ return l <= x && x <=\
    \ r; }\n\tprotected static final int clamp(final int l, final int x, final int\
    ...
    \ >= 0;) {\n\t\t\tif(a[i].equals(x)) {\n\t\t\t\treturn i;\n\t\t\t}\n\t\t}\n\t\t\
    return -1;\n\t}\n\tpublic static final boolean binarySearch(final int[] a, final\
    \ int x){ return Arrays.binarySearch(a, x) >= 0; }\n\tpublic static final boolean\
    \ binarySearch(final long[] a, final long x){ return Arrays.binarySearch(a, x)\
    ...
    \ final int lowerBound(final int[] a, final int x){ return bins(a.length, -1,\
    ...
    \ 1 : -1); }\n\tpublic static final int upperBound(final int[] a, final int x){\
    \ return bins(a.length, -1, (IntPredicate) y -> a[y] > x); }\n\tpublic static\
    \ final int upperBound(final long[] a, final long x){ return bins(a.length, -1,\
    ...
    \ > 0 ? 1 : -1); }\n\tpublic static final String sorted(final String s){ return\
    ...
    \tfor(int i = 0; i < a.length; ++i) {\n\t\t\tres[i] = t.get(i);\n\t\t}\n\t\treturn\
    \ res;\n\t}\n\tpublic static final double[] rotate(final double[] a, final int\
    \ id) {\n\t\tfinal List<Double> t = Arrays.stream(a).boxed().collect(Collectors.toList());\n\
    \t\tCollections.rotate(t, id);\n\t\tfinal double[] res = new double[a.length];\n\
    \t\tfor(int i = 0; i < a.length; ++i) {\n\t\t\tres[i] = t.get(i);\n\t\t}\n\t\t\
    return res;\n\t}\n\tpublic static final String rotate(final String s, final int\
    ...
    \ }\n\tpublic static final int[] iota(final int n){ return IntStream.range(0,\
    \ n).toArray(); }\n\tpublic static final int[] iota(final int n, final int init){\
    \ return IntStream.range(0 + init, n + init).toArray(); }\n\tprotected static\
    \ final int bins(int ok, int ng, final IntPredicate fn) {\n\t\twhile(Math.abs(ok\
...
layout: document
redirect_from:
- /library/Java/library/core/Utility.java
- /library/Java/library/core/Utility.java.html
