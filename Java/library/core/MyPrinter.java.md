...
data:
  ...
  bundledCode: "Traceback (most recent call last):\n  File \"/home/runner/.local/lib/python3.10/site-packages/onlinejudge_verify/documentation/build.py\"\
    ...
    RuntimeError: bundler is not specified: Java/library/core/MyPrinter.java\n"
  code: "package library.core;\n\nimport java.io.Closeable;\nimport java.io.Flushable;\n\
    import java.io.IOException;\nimport java.io.OutputStream;\nimport java.util.Arrays;\n\
    import java.util.Collection;\nimport java.util.Formatter;\nimport java.util.List;\n\
    import java.util.stream.IntStream;\n\nimport library.pair.Pair;\n\nfinal class\
    \ MyPrinter implements Closeable, Flushable, AutoCloseable {\n\tprivate OutputStream\
    ...
    \ void printf(final String fmt, final Object... args){ print(new Formatter().format(fmt,\
    ...
    \ int[] args){ IntStream.range(0, args.length).forEach(i -> print(args[i] + (i\
    ...
    n\"))); }\n\tfinal void out(final boolean[] args){ IntStream.range(0, args.length).forEach(i\
  ...
  verifiedWith: []
documentation_of: Java/library/core/MyPrinter.java
layout: document
redirect_from:
- /library/Java/library/core/MyPrinter.java
- /library/Java/library/core/MyPrinter.java.html
