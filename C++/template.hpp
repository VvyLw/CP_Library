...
#define rvp1(n) for(const auto i: std::views::iota(0) | std::views::take(n) | std::views::reverse)
#define rvp2(i,n) for(const auto i: std::views::iota(0) | std::views::take(n) | std::views::reverse)
