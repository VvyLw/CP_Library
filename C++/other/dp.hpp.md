...
data:
  ...
  bundledCode: "#line 2 \"C++/other/dp.hpp\"\n\n#include <vector>\n#include <utility>\n\
    ...
    \ inline T knapsack01_v(const std::vector<int> &a, const std::vector<T> &v, const\
  ...
  code: "#pragma once\n\n#include <vector>\n#include <utility>\n#include <algorithm>\n\
    #include <stack>\n#include <iterator>\n#include <limits>\n#include <numeric>\n\
    #include <ranges>\n\nnamespace man {\ntemplate <class T> constexpr inline T knapsack01_v(const\
    \ std::vector<int> &a, const std::vector<T> &v, const int w) noexcept {\n    const\
    \ int n = std::ssize(a);\n    std::vector dp(w + 1, std::numeric_limits<T>::min());\n\
